    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="mb-2 fw-bold">Dashboard Super Admin</h1>
            ...
            <div class="card border-0 shadow-sm h-100 card-hover">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <p class="text-muted mb-1 small fw-medium">Total Admin</p>
                            <h3 class="mb-0 fw-bold">{{ $totalAdmin ?? 0 }}</h3>
    ...
    <div class="row g-3">
        <div class="col-xl-6">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-footer bg-white border-0 text-center">
                    <a href="#" class="text-decoration-none small fw-medium">Lihat Semua Aktivitas <i class="bi bi-arrow-right"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-6">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-footer bg-white border-0 text-center">
                    <a href="#" class="text-decoration-none small fw-medium">Lihat Semua Teknisi <i class="bi bi-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
